...
@registry.ROI_KEYPOINT_HEADS.register("roi_gce_head")
class roi_gce_head(nn.Module):
    def __init__(self, dim_in, spatial_scale):
        ...
        use_nl = cfg.KRCNN.GCE_HEAD.USE_NL
        use_bn = cfg.KRCNN.GCE_HEAD.USE_BN
        use_gn = cfg.KRCNN.GCE_HEAD.USE_GN
        conv_dim = cfg.KRCNN.GCE_HEAD.CONV_DIM
        asppv3_dim = cfg.KRCNN.GCE_HEAD.ASPPV3_DIM
        num_convs_before_asppv3 = cfg.KRCNN.GCE_HEAD.NUM_CONVS_BEFORE_ASPPV3
        asppv3_dilation = cfg.KRCNN.GCE_HEAD.ASPPV3_DILATION
        num_convs_after_asppv3 = cfg.KRCNN.GCE_HEAD.NUM_CONVS_AFTER_ASPPV3
