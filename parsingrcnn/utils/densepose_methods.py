...
class DensePoseMethods:
    def __init__(self):
        #
        if os.path.exists(os.path.join(os.path.dirname(__file__), '../../data/DensePoseData/UV_data/UV_Processed.mat')) \
            and os.path.exists(os.path.join(os.path.dirname(__file__), '../../data/DensePoseData/UV_data/UV_symmetry_transforms.mat')):
            ALP_UV = loadmat( os.path.join(os.path.dirname(__file__), '../../data/DensePoseData/UV_data/UV_Processed.mat')  )
            ...
            UV_symmetry_filename = os.path.join(os.path.dirname(__file__), '../../data/DensePoseData/UV_data/UV_symmetry_transforms.mat')
