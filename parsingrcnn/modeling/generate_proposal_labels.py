...
from parsingrcnn.datasets import json_dataset
...
class GenerateProposalLabelsOp(nn.Module):
    ...
    def forward(self, rpn_rois, roidb, im_info):
        ...
        output_blob_names = roi_data_fast_rcnn.get_fast_rcnn_blob_names()
        ...
        roi_data_fast_rcnn.add_fast_rcnn_blobs(blobs, im_scales, roidb)
