...
import parsingrcnn.utils.densepose_methods as dp_utils
...
def add_uv_rcnn_blobs(blobs, sampled_boxes, roidb, im_scale, batch_idx):
    ...
    if cfg.MODEL.MIXTRAIN_ON and not roidb['has_uv']:
    ...
    blobs['uv_U_points'] = U_points.astype(np.float32)  #### VERY IMPORTANT :   These are switched here :
